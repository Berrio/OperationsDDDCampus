...
public class UpdateServiceRequest extends Command {
    ...
    public UpdateServiceRequest(ClientID clientID, ServiceID serviceID, TypeOfRequest typeOfRequest, Description description, StateName stateName) {
